...
public static b4j.example.dbutils _dbutils = null;
  public Object[] GetGlobals() {
		return new Object[] {"CustomerView",Debug.moduleToString(b4j.example.customerview.class),"Dashboard",Debug.moduleToString(b4j.example.dashboard.class),"DBUtils",Debug.moduleToString(b4j.example.dbutils.class),"LoginForm",Debug.moduleToString(b4j.example.loginform.class),"Main",Debug.moduleToString(b4j.example.main.class),"RegistrationForm",Debug.moduleToString(b4j.example.registrationform.class)};
}
}
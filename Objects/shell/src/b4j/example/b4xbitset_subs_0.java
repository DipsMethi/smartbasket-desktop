...
try {
		Debug.PushSubsStack("Get (b4xbitset) ","b4xbitset",11,__ref.getField(false, "ba"),__ref,38);
...
try {
		Debug.PushSubsStack("getSize (b4xbitset) ","b4xbitset",11,__ref.getField(false, "ba"),__ref,49);
...
try {
		Debug.PushSubsStack("Initialize (b4xbitset) ","b4xbitset",11,__ref.getField(false, "ba"),__ref,10);
...
try {
		Debug.PushSubsStack("Set (b4xbitset) ","b4xbitset",11,__ref.getField(false, "ba"),__ref,16);

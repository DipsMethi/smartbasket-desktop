...
try {
		Debug.PushSubsStack("Clear (b4xorderedmap) ","b4xorderedmap",16,__ref.getField(false, "ba"),__ref,26);
...
try {
		Debug.PushSubsStack("ContainsKey (b4xorderedmap) ","b4xorderedmap",16,__ref.getField(false, "ba"),__ref,46);
...
try {
		Debug.PushSubsStack("Get (b4xorderedmap) ","b4xorderedmap",16,__ref.getField(false, "ba"),__ref,37);
...
try {
		Debug.PushSubsStack("GetDataForSerializator (b4xorderedmap) ","b4xorderedmap",16,__ref.getField(false, "ba"),__ref,65);
...
try {
		Debug.PushSubsStack("GetDefault (b4xorderedmap) ","b4xorderedmap",16,__ref.getField(false, "ba"),__ref,42);
...
try {
		Debug.PushSubsStack("getKeys (b4xorderedmap) ","b4xorderedmap",16,__ref.getField(false, "ba"),__ref,32);
...
try {
		Debug.PushSubsStack("getSize (b4xorderedmap) ","b4xorderedmap",16,__ref.getField(false, "ba"),__ref,50);
...
try {
		Debug.PushSubsStack("getValues (b4xorderedmap) ","b4xorderedmap",16,__ref.getField(false, "ba"),__ref,55);
...
try {
		Debug.PushSubsStack("Initialize (b4xorderedmap) ","b4xorderedmap",16,__ref.getField(false, "ba"),__ref,6);
...
try {
		Debug.PushSubsStack("Put (b4xorderedmap) ","b4xorderedmap",16,__ref.getField(false, "ba"),__ref,12);
...
try {
		Debug.PushSubsStack("Remove (b4xorderedmap) ","b4xorderedmap",16,__ref.getField(false, "ba"),__ref,20);
...
try {
		Debug.PushSubsStack("SetDataFromSerializator (b4xorderedmap) ","b4xorderedmap",16,__ref.getField(false, "ba"),__ref,70);

...
try {
		Debug.PushSubsStack("Initialize (b4xcomparatorsort) ","b4xcomparatorsort",15,__ref.getField(false, "ba"),__ref,4);
...
try {
		Debug.PushSubsStack("Partition (b4xcomparatorsort) ","b4xcomparatorsort",15,__ref.getField(false, "ba"),__ref,30);
...
try {
		Debug.PushSubsStack("QuickSort (b4xcomparatorsort) ","b4xcomparatorsort",15,__ref.getField(false, "ba"),__ref,21);
...
try {
		Debug.PushSubsStack("Sort (b4xcomparatorsort) ","b4xcomparatorsort",15,__ref.getField(false, "ba"),__ref,12);
...
try {
		Debug.PushSubsStack("Swap (b4xcomparatorsort) ","b4xcomparatorsort",15,__ref.getField(false, "ba"),__ref,44);

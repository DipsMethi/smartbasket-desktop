...
try {
		Debug.PushSubsStack("Add (b4xset) ","b4xset",17,__ref.getField(false, "ba"),__ref,9);
...
try {
		Debug.PushSubsStack("AsList (b4xset) ","b4xset",17,__ref.getField(false, "ba"),__ref,29);
...
try {
		Debug.PushSubsStack("Clear (b4xset) ","b4xset",17,__ref.getField(false, "ba"),__ref,25);
...
try {
		Debug.PushSubsStack("Contains (b4xset) ","b4xset",17,__ref.getField(false, "ba"),__ref,17);
...
try {
		Debug.PushSubsStack("getSize (b4xset) ","b4xset",17,__ref.getField(false, "ba"),__ref,21);
...
try {
		Debug.PushSubsStack("Initialize (b4xset) ","b4xset",17,__ref.getField(false, "ba"),__ref,5);
...
try {
		Debug.PushSubsStack("Remove (b4xset) ","b4xset",17,__ref.getField(false, "ba"),__ref,13);
